...
export class ReportService {
  ...
  async userPromptReport(data: UpdateReportDto): Promise<any> {
    const report = await this.chatservice.userPrompt(data);
    return await this.reportRepository.saveReport(report.aiMessage, new Date());
  }
}
